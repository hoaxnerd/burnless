...
export default defineConfig({
  ...
  projects: [
    ...
    // get the pre-authenticated context automatically.
    {
      ...
      use: { ...devices["Desktop Chrome"] },
      dependencies: ["setup"],
      testMatch: /critical-user-flows\.spec\.ts|sidebar-floating\.spec\.ts|data-room-hub\.spec\.ts|edit-delete-entries\.spec\.ts|ai-ux\.spec\.ts|comprehensive-crud\.spec\.ts|scenario-isolation\.spec\.ts|settings-wiring\.spec\.ts|dashboard-features\.spec\.ts/,
    },
  ],
