...
export default function VerifyEmailError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-surface-50 dark:bg-surface-950">
      <div className="rounded-2xl bg-surface-0 border border-surface-200 p-12 text-center max-w-md">
        ...
        <p className="text-sm text-surface-500 mb-6">We hit an unexpected error verifying your email.</p>
