...
// Schema lives in ./schema (not here): Next.js route modules may only export
// route fields, and the production build rejects `export const enrichSchema`.
import { enrichSchema } from "./schema";
