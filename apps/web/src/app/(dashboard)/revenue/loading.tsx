  ...
  return (
    <div className="animate-fade-in" role="status" aria-label="Loading revenue">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        {[1, 2].map((i) => (
          <div key={i} className="rounded-xl border border-surface-200 bg-surface-0 p-6">
      ...
      <div className="rounded-xl border border-surface-200 bg-surface-0 p-6 mb-6">
        ...
        <Sk className="h-[260px] w-full rounded-lg" />
      </div>

      {/* Stream breakdown skeleton */}
