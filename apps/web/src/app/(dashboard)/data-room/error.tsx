...
function classifyError(error: Error) {
  ...
  if (msg.includes("fetch") || msg.includes("network"))
    return { icon: WifiOff, title: "Connection issue", message: "Could not reach the server. Check your connection and try again." };
  if (msg.includes("timeout") || msg.includes("aborted"))
    return { icon: Clock, title: "Request timed out", message: "The page took too long to load. Try again." };
  return { icon: AlertTriangle, title: "Data room unavailable", message: "Something went wrong loading the data room. This has been logged." };
}
