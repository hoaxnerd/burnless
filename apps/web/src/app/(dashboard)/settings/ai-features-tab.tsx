...
import { Power, Database, Sparkles, DollarSign } from "lucide-react";
...
interface AiFeaturesTabProps {
  ...
  updateFlags: (patch: Partial<AiFeatureFlagsState & { monthlyBudgetCents?: number }>) => void;
  monthlyBudgetCents: number;
  budget: BudgetStatus | null;
}

export function AiFeaturesTab({ flags, updateFlags, monthlyBudgetCents, budget }: AiFeaturesTabProps) {
  return (
